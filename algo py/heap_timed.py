...
insertThen = time.perf_counter()
for i in a:
    max_heap.insert_key(i)
insertNow = time.perf_counter()


print("Initial Heap:")
max_heap.print_heap()

print("Time taken in insertion:",str(decimal.Decimal(insertNow - insertThen)))
...
print("Time taken in Deletion of Root:",str(decimal.Decimal(insertNow - insertThen)))

insertThen = time.perf_counter()
heapSort(a)
insertNow = time.perf_counter()

print("Time taken in Heap Sort:",str(decimal.Decimal(insertNow - insertThen)))